Alarmproject::Application.routes.draw do
  ...
  match 'mapval/:model/:scenario/:year/:function/(:variable)' => 'values#mapval', :function => /min|max|avg/
  ...
  match 'mapdiff/:model/:scenario/:year1/:function1/:year2/:function2/(:variable)' => 'values#mapdiff', :function1 => /min|max|avg/, :function2 => /min|max|avg/
