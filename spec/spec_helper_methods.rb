module SpecHelperMethods
  ...
  def create_dummy_data
    ...
    # extra years
    Value.create!(year: 2002, month: 3, number: 15, model_id: model.id, 
                  scenario_id: scenario1.id, variable_id: variable1.id,
                  point_id: point2.id)    
    Value.create!(year: 2003, month: 10, number: 26, model_id: model.id, 
                  scenario_id: scenario1.id, variable_id: variable1.id,
                  point_id: point2.id)
    Value.create!(year: 2004, month: 1, number: 26, model_id: model.id, 
                  scenario_id: scenario1.id, variable_id: variable1.id,
                  point_id: point2.id)
  end
